...
class BootstrapEmail {
	...
	injectInlineCss() {
		const style = parseCss(BootstrapEmail._loadStyle(this._stylePath));
		// TODO: inline css
	}
	...
	static _compileHtml($) {
		...
		BootstrapEmail._replace($, '.mx-center', 'align-center');
		...
		BootstrapEmail._replace($, '*[class*=my-], *[class*=mt-], *[class*=mb-]', 'div');
		BootstrapEmail._replace($, '*[class*=s-]', 'div', 'w-100');
